...
public class GenerateConfig {
	...
	private String parentName; //代码生成的parent
	...
	private String factoryTag; //数据库配置标识
	
	private String useTransactional; //是否使用注解事务
	
	private String useCache; //是否使用缓存
	
	private String databaseName; //所在的数据集的名称
	
	private String saveLog; //是否记录系统日志.
	...
	public GenerateConfig(String databaseName,String tableName,String parentName, String systemName, String packageName, String primaryKeyStyle,String factoryTag,String useTransactional,String useCache,String saveLog)
			throws Exception {
	...
	public GenerateConfig(String databaseName,String tableName, String parentName,String systemName, String packageName, String primaryKeyStyle,
			String instancePackage,String factoryTag,String useTransactional,String useCache,String saveLog) throws Exception {
