...
import com.application.base.pay.entity.QuickBillCodeDesc;
...
public class QuickBillXmlHandler {
	...
	public static Map<String, Object> responseCodeHandle(Map<String, Object> respXml) {
		...
		if (respXml.get("responseCode") != null && "00".equals(respXml.get("responseCode").toString())) {
		...
		else if (respXml.get("responseCode") != null && !"00".equals(respXml.get("responseCode").toString())) {
