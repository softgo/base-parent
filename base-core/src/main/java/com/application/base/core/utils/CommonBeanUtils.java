...
public class CommonBeanUtils {
	...
	public static Map<String, Object> getValueMap(Map<String, Object> inputMap) {
		...
		try {
			for (Map.Entry<String, Object>  entry : inputMap.entrySet()) {
				...
				if (value.toString().equalsIgnoreCase("-1") || "".equals(value)) {
					continue;
				}
	 ...
	 */
	@SuppressWarnings({ "unchecked", "finally" })
	public static <T extends BaseBean> T getUpdateBeanInfo(Class<? extends BaseBean> clazz,List<String> coloums) {
